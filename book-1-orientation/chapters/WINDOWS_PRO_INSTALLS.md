...
1. [SQL Server Express](https://www.microsoft.com/en-us/sql-server/sql-server-downloads) - Chose the `Express` option. This is the database tool where all your data will be stored for the server-side course.
